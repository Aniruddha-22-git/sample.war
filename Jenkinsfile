...
*/
  ...
  */
  	sh "wget  -O /mnt/apache-tomcat-9.0.91/webapps/sample.war https://tomcat.apache.org/tomcat-7.0-doc/appdev/sample/sample.war"
   	sh "  chmod -R 777 /mnt/apache-tomcat-9.0.91/webapps/sample.war"
    	sh "cd /mnt/apache-tomcat-9.0.91/bin/ && ./startup.sh"
